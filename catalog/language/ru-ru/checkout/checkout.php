...
$_['text_checkout_option']           = '%s Способ оформления заказа';
$_['text_checkout_account']          = '%s КОНТАКТНЫЕ ДАННЫЕ';
$_['text_checkout_payment_address']  = '%s Платежная информация';
$_['text_checkout_shipping_address'] = '%s Адрес доставки';
$_['text_checkout_shipping_method']  = '2 Способ доставки';
$_['text_checkout_payment_method']   = '3 Способ оплаты';
$_['text_checkout_confirm']          = '6 Подтверждение заказа';
...
$_['text_shipping_method']           = 'Выберите удобный способ доставки';
...
$_['entry_address_1']                = 'Адрес отделения';
