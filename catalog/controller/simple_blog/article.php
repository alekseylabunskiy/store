		...
		public function index() {
			...
			foreach($results as $result) {
				...
				if ($result['featured_image']) {
					...
					$featured_found = 1;
					$image = $this->model_tool_image->resize($result['featured_image'], $this->config->get($this->config->get('config_theme') . '_image_blog_width'), $this->config->get($this->config->get('config_theme') . '_image_blog_height'));
                    $image2x = $this->model_tool_image->resize($result['featured_image'], $this->config->get($this->config->get('config_theme') . '_image_blog_width')*2, $this->config->get($this->config->get('config_theme') . '_image_blog_height')*2);

                } else if($result['image']) {
					//$image = HTTP_SERVER . 'image/' . $result['image'];
					$featured_found = '';
					$image = $this->model_tool_image->resize($result['image'], $this->config->get($this->config->get('config_theme') . '_image_blog_width'), $this->config->get($this->config->get('config_theme') . '_image_blog_height'));
                    $image2x = $this->model_tool_image->resize($result['image'], $this->config->get($this->config->get('config_theme') . '_image_blog_width')*2, $this->config->get($this->config->get('config_theme') . '_image_blog_height')*2);
                } else {
					$image = false;
			...
			if ($simple_blog_article_id) {
				...
				if($article_info) {
					...
					if($article_info['featured_image']) {
                        ...
                        $data['image'] = $this->model_tool_image->resize($article_info['featured_image'], $this->config->get($this->config->get('config_theme') . '_image_blog_width'), $this->config->get($this->config->get('config_theme') . '_image_blog_height'));
                        $data['image2x'] = $this->model_tool_image->resize($article_info['featured_image'], $this->config->get($this->config->get('config_theme') . '_image_blog_width'), $this->config->get($this->config->get('config_theme') . '_image_blog_height'));
                    } else if($article_info['image']) {
						//$data['image'] = HTTP_SERVER . 'image/' . $article_info['image'];
						$featured_found = '';
                        $data['image'] = $this->model_tool_image->resize($article_info['image'], $this->config->get($this->config->get('config_theme') . '_image_blog_width'), $this->config->get($this->config->get('config_theme') . '_image_blog_height'));
                        $data['image2x'] = $this->model_tool_image->resize($article_info['image'], $this->config->get($this->config->get('config_theme') . '_image_blog_width'), $this->config->get($this->config->get('config_theme') . '_image_blog_height'));
                    } else {
						$data['image'] = '';
						$featured_found = '';
					}
