    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-novaposhta" class="form-horizontal">
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-status">Обновление</label>
            <div class="col-sm-10">
              <button class="btn btn-info" id="update_nova_pochta">Обновить отделения новой почты</button>
            </div>
          </div>
        </form>
      </div>
...
<script>
  $('#update_nova_pochta').click(function (event) {
